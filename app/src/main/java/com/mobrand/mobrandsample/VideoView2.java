 ...
 *
 */
public class VideoView2 extends TextureView implements MediaPlayerControl {
    ...
    public VideoView2(final Context context) {
        super(context);
        mContext = context;
        initVideoView();
    }
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        if ((mVideoWidth > 0) && (mVideoHeight > 0)) {
            if ((mVideoWidth * height) > (width * mVideoHeight)) {
                Log.d(TAG, "Video too tall, change size." + " video size is " + mVideoWidth + "x" + mVideoHeight);
                height = (width * mVideoHeight) / mVideoWidth;
            } else if ((mVideoWidth * height) < (width * mVideoHeight)) {
                Log.d(TAG, "Video too wide, change size." + " video size is " + mVideoWidth + "x" + mVideoHeight);
...
//				}).setCancelable(false).show();
    ...
    SurfaceTextureListener mSurfaceTextureListener = new SurfaceTextureListener() {
        ...
        public boolean onSurfaceTextureDestroyed(final SurfaceTexture surface) {
            ...
            Log.d(TAG, "onSurfaceTextureSizeDestroyed");
