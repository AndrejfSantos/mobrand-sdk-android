...
public class TabBarView extends LinearLayout {
    ...
    private void setAttributes(Context context, AttributeSet attrs){
        ...
        if (theme != null) {
            TypedArray typedArray = theme.obtainStyledAttributes(attrs, R.styleable.tabBar_view, 0, 0);
            if (typedArray != null) {
                ...
                for (int i = 0; i < n; i++){
                    ...
                    if (attr == R.styleable.tabBar_view_tabBarColor) {
                        int color = typedArray.getColor(i, Color.WHITE);
                        paint.setColor(color);

                    } else if (attr == R.styleable.tabBar_view_tabBarSize) {
